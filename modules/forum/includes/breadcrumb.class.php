...
class nav_bits {
    ...
    {
        global $diy_db;
        $result = $diy_db->query("SELECT catid,parent,cat_title FROM diy_forum_cat ORDER BY catid ASC");
        ...
        {
            $Last .='<a href="mod.php?mod=forum&modfile=list&catid='.$NewArray[$i]['id'].'"> '.$NewArray[$i]['title'].' &raquo;</a>';
        }
