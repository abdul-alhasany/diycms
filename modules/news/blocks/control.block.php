...
/**
 ...
 if ($perm) {
     $waiting_posts    = $diy_db->dbnumquery("diy_news", "allow != 'yes'");
     $waiting_comments = $diy_db->dbnumquery("diy_news_comments", "allow != 'yes'");
     
     eval("\$index_middle .= \" " . $mod->gettemplate('news_block_admin') . "\";");
 }
 echo $index_middle;
