...
/**
 ...
 if ($submit) {
     ...
     $result = $diy_db->query("insert into diy_news_cat (cat_order,
                                                    parent,
                                                    cat_title,
                                                    dsc,
													grouppost,
     ...
     if ($result) {
         ...
         info_message($lang['CONTROL_ADDCAT_SUCCESSFUL'], "mod.php?mod=news&dir=control&modfile=viewcat");
     } else {
     ...
     $result       = $diy_db->query("select * from diy_news_cat order by catid");
     $cat_array[0] = 'Main';
     ...
     $form_array = array(
         "action" => "mod.php?mod=news&dir=control&modfile=addcat",
