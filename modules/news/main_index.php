...
include("modules/".$mod->module."/includes/cat_counter.class.php");
	...
	$cat_counter = new cat_counter;
		...
		$all_categories= $diy_db->query("SELECT catid,parent,countopic,countcomm
         ...
         {
             $cateogries_array[] = array ('catid'=> $cat_array['catid'],
    ...
    if($newsColcount < 1 ) $newsColcount = 1;
    $result = $diy_db->query("SELECT * FROM diy_news_cat WHERE parent=0 ORDER BY cat_order ASC");
