...
$query[] = "INSERT INTO diy_modules_settings VALUES ('', '$module', 'MESSAGE_TYPES', 'message_types', '”ƒ«·\n«ﬁ —«Õ\n—”«·…', '".$i++."', 4);";
...
foreach($xml->main_group as $child)
 ...
 $diy_db->query("INSERT INTO diy_menu VALUES ('', 'contact-us control', 'standard_menu', 'mainmenu', ' Õﬂ„ «·« ’«· »‰«', '<!--INC dir=\"modules/contact-us/blocks\" file=\"control.block.php\" -->', '2','1','$modid', '0', '1');");
