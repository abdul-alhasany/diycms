 ...
 if ($_POST['submit'])
{
  ...
  $result = $diy_db->query("insert into diy_download_cat (cat_order,
                                                    parent,
                                                    cat_title,
                                                    dsc,
													grouppost,
  ...
  if ($result)
  {
    ...
    info_message($lang['CONTROL_ADDCAT_SUCCESSFUL'], "mod.php?mod=download&dir=control&modfile=viewcat");
  }
  else
  {
...
else
{
  ...
  $form_array = array("action" => "mod.php?mod=download&dir=control&modfile=addcat", "title" => "$lang[CONTROL_ADDCAT]", "name" => 'add_cat', "content" => $add_cat, "submit" =>
    'Submit');
