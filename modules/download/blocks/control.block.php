...
if ($perm)
{
  $waiting_posts = $diy_db->dbnumquery("diy_download_files", "allow != 'yes'");
  $waiting_comments = $diy_db->dbnumquery("diy_download_comments", "allow != 'yes'");

  eval("\$index_middle .= \" " . $mod->gettemplate('download_block_admin') . "\";");
}
echo $index_middle;
