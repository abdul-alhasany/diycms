...
<body bgcolor='#9EC5E1'><br><div align='center'><br><br><br><br><br><br>
	...
	<tr><td rowspan="2" width='20%' align='center'><img border='0' src="<#admin_images_path#>/info.png"></td>
	<td width='80%' align='center'><b><font size="5"><br>{MSG}<br></font></td>
	</tr>
	<tr>
	<td class="cell"><center><b><font size="3"><br><img border='0' src="<#admin_images_path#>/loading.gif"><br><br><?php printf(lang('INFO_MESSAGE_REDIRECT'), '{SECONDS}' ); ?><br>&nbsp;</font></table></center></div>